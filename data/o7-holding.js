...
export const holdingProduits = [
  {
    ...
    description: "Solutions propriétaires pour la gestion et coordination d'opérations internationales.",
  },
  {
    id: 2,
    icon: "feather-box",
    title: "Frameworks Internes",
    description: "Frameworks et outils développés et opérés par le groupe pour standardiser les opérations.",
  },
  {
    id: 3,
    icon: "feather-settings",
    title: "Solutions Propriétaires",
    description: "Technologies et méthodologies développées en interne pour optimiser la gouvernance du groupe.",
  },
];
...
export const holdingEntites = [
  ...
  },
  {
    ...
    role: "Accompagnement des entrepreneurs et entreprises internationales dans leur implantation aux États-Unis : structuration IT, digitale et opérationnelle, coordination des expertises du groupe (infogérance, infrastructure, solutions métiers, conseil)",
    icon: "feather-flag",
  },
  {
    id: 4,
    ...
    adresse: "Los Angeles, California",
    role: "Immobilier, structuration d'actifs et projets immobiliers liés à l'implantation et au développement aux USA",
    icon: "feather-home",
  },
  {
    id: 5,
